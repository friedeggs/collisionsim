...
/** Returns a position vector pointing from this ball 
 * to the specified ball. The magnitude of the vector
 * is equal to the distance between the balls. 
 */
 ...
 * of this ball and the radius of the specified ball.
 */
