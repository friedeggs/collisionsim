 ...
 * that will be written to the specified output path in
 * .csv format when the write() method is called.
 */
 ...
 * Logs the current position and velocity of all monitored
 * balls at the current time.
 */
 ...
 * specified in the constructor for this class. Returns
...
bool DataExporter::write()
{
    ...
    // `trunc` - if the file already exists, wipe out existing data
